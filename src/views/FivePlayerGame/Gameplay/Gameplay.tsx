...
const previousRound = (players: Array<Player>, lineup: Lineup, score: Score) => {
    return <TableRow>
        ...
        <TableCell><Typography
            variant="title">{score.roundResult.blue} - {score.roundResult.red}</Typography></TableCell>
...
const roundScoreModeTwo = (addLineupScore: (roundResult: RoundResult) => void) => <div>
    <Fab onClick={() => addLineupScore({blue: 2, red: 0})} className="score-button" size="small"
         color="primary">2-0</Fab>
    <Fab onClick={() => addLineupScore({blue: 1, red: 1})} className="score-button" size="small"
         color="default">1-1</Fab>
    <Fab onClick={() => addLineupScore({blue: 0, red: 2})} className="score-button" size="small"
         color="secondary">0-2</Fab>
</div>;

const roundScoreModeThree = (addLineupScore: (roundResult: RoundResult) => void) => <div>
    <Fab onClick={() => addLineupScore({blue: 3, red: 0})} className="score-button" size="small"
         color="primary">3-0</Fab>
    <Fab onClick={() => addLineupScore({blue: 2, red: 1})} className="score-button" size="small"
         color="primary">2-1</Fab>
    <Fab onClick={() => addLineupScore({blue: 1, red: 2})} className="score-button" size="small"
         color="secondary">1-2</Fab>
    <Fab onClick={() => addLineupScore({blue: 0, red: 3})} className="score-button" size="small"
         color="secondary">0-3</Fab>
</div>;

const roundScoreModeFour = (addLineupScore: (roundResult: RoundResult) => void) => <div>
    <Fab onClick={() => addLineupScore({blue: 4, red: 0})} className="score-button" size="small"
         color="primary">4-0</Fab>
    <Fab onClick={() => addLineupScore({blue: 3, red: 1})} className="score-button" size="small"
         color="primary">3-1</Fab>
    <Fab onClick={() => addLineupScore({blue: 2, red: 2})} className="score-button" size="small"
         color="default">2-2</Fab>
    <Fab onClick={() => addLineupScore({blue: 1, red: 3})} className="score-button" size="small"
         color="secondary">1-3</Fab>
    <Fab onClick={() => addLineupScore({blue: 0, red: 4})} className="score-button" size="small"
...
const currentRound = (players: Array<Player>, lineup: Lineup, addLineupScore: (roundResult: RoundResult) => void, scoreMode: ScoreMode) => {
    return <TableRow>
        <TableCell><Typography variant="h6">{blueLineup(players, lineup)}</Typography></TableCell>
        <TableCell>{currentRoundScores(addLineupScore, scoreMode)}</TableCell>
        <TableCell><Typography variant="h6">{redLineup(players, lineup)}</Typography></TableCell>
    </TableRow>
};

const nextRound = (players: Array<Player>, lineup: Lineup) => <TableRow>
        <TableCell>{blueLineup(players, lineup)}</TableCell>
        <TableCell>Next round</TableCell>
        <TableCell>{redLineup(players, lineup)}</TableCell>
    </TableRow>;

const lastRound = () => <TableRow>
    <TableCell></TableCell>
...
export const Gameplay = (props: Props) => <>
    ...
    <Table id="gameplay" className="table centered striped is-fullwidth">
        ...
        <TableBody>
            ...
            {props.roundIndex < props.roundCount - 1 ?
